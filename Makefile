...
U_SRCS = init.c idle.c brk.c fork.c to_exec.c exec1.c exec2.c wait_exit.c pid_test.c ttyread_test.c simul_ttywrite.c spam_ttywrite.c ttywrite.c trap_mem.c trap_math.c pipe_basic.c ipc_basic.c
U_INCS =
