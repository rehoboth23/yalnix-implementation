...
K_SRCS = kernel.c traphandlers.c process.c queue.c contextswitch.c load.c
K_INCS = kernel.h traphandlers.h process.h queue.h contextswitch.h load.h include.h
