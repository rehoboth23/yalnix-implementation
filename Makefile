...
U_SRCS = init.c idle.c brk.c fork.c to_exec.c exec1.c exec2.c wait_exit.c pid_test.c tty_test1.c tty_test2.c simul_ttywrite.c spam_ttywrite.c ttywrite.c
U_INCS =
