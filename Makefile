...
K_SRCS = kernel.c traphandlers.c process.c queue.c contextswitch.c loadprogram.c
K_INCS = kernel.h traphandlers.h process.h queue.h contextswitch.h loadprogram.h
